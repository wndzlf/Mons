...
//  Mons
//
//  Created by Jiyong Park on 27/05/2018.
...
class ImagePreviewViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        myCollectionView.register(ImagePreviewCell.self, forCellWithReuseIdentifier: "Cell")
        myCollectionView.isPrefetchingEnabled = true
...
class ImagePreviewCell: UICollectionViewCell, UIScrollViewDelegate {
    ...
    override init(frame: CGRect) {
        ...
        imgView = UIImageView()
        imgView.image = UIImage(named: "icon_banner2")
