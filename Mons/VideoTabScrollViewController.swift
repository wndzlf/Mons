...
class VideoTabScrollViewController: UIViewController, ACTabScrollViewDelegate, ACTabScrollViewDataSource {
    let categories = myDatas.videoCategoryArray
    ...
    override func viewDidLoad() {
        ...
        for i in 0 ..< categories.count {
            let vc = storyboard.instantiateViewController(withIdentifier: "YoutubeViewController") as! YoutubeViewController
